...
# blader/humanizer (35 паттернов «Signs of AI writing», Wikipedia), адаптация
# под короткие русские сообщения репетитора. Полный чеклист: docs/HUMAN_STYLE.md
_HUMAN_STYLE = (
    ...
    "риторические перечисления из трёх элементов ради красоты, списки и эмодзи, "
    "больше одного тире «—», комплименты заказу, дежурные концовки "
